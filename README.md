About splits-feedstock
======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/splits-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3585&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/splits-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `splits` can be installed with `conda`:
...
```
mamba install splits
```

It is possible to list all of the versions of `splits` available on your platform with `conda`:
...
```
mamba search splits --channel conda-forge
```
...
mamba repoquery search splits --channel conda-forge

# List packages depending on `splits`:
mamba repoquery whoneeds splits --channel conda-forge

# List dependencies of `splits`:
mamba repoquery depends splits --channel conda-forge
```
